...
class HeadLineActivity : AppCompatActivity() {
    ...
    fun getListArticle(url:String){
        getRetrofit(url)
            ?.enqueue(object : Callback<ResponseArticles> {
                override fun onResponse(
                    ...
                    Toast.makeText(this@HeadLineActivity, "Get data berhasil", Toast.LENGTH_LONG)
                        .show()
                ...
                override fun onFailure(call: Call<ResponseArticles>, t: Throwable) {
                    Toast.makeText(this@HeadLineActivity, "Login Gagal", Toast.LENGTH_LONG)
                        .show()
        ...
        rvArticles.apply{
            layoutManager = LinearLayoutManager(this@HeadLineActivity)
            adapter = newsAdapter
        }
    }
}